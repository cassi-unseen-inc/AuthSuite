    ...
    private Object rebuildServices(Object original) throws Exception {
        ...
        for (int i = 0; i < components.length; i++) {
            ...
            if (value instanceof MinecraftSessionService sessionService) {
                ...
                // SignatureValidator / GameProfileRepository / GameProfileCache pass
                // through unchanged. Chat-key stripping is done on the built
                // GameProfile (profilePublicKey removed) in LoginProfileBuilder.
                args[i] = value;
            }
        }

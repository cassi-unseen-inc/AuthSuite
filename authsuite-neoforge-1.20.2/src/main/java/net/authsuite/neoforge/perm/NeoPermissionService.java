package net.authsuite.neoforge.perm;
 ...
 */
public final class NeoPermissionService implements PermissionService {
    ...
    public NeoPermissionService(IdentityRegistry identityRegistry, ProviderManager providerManager,
    ...
    private OpsRouter router() {
        return net.authsuite.neoforge.NeoForgeServer.get() != null
                ? net.authsuite.neoforge.NeoForgeServer.get().opsRouter()
                : null;
    }

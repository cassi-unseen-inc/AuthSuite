...
/**
 * Forge 1.16.5 network wiring using the FML {@code SimpleChannel} API. Registers the
...
public final class ForgeNetwork {
    ...
    public static void sendToPlayer(ServerPlayerEntity player, PlayerSkinDirectivePayload payload) {

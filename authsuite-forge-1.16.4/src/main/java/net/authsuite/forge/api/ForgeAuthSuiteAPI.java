package net.authsuite.forge.api;
 ...
 */
public final class ForgeAuthSuiteAPI implements AuthSuiteAPI {
    ...
    public ForgeAuthSuiteAPI(IdentityRegistry identityRegistry,
    ...
    public SkinDirective getServerSkinDirective(UUID canonicalUuid) {
        return net.authsuite.forge.ForgeServer.get() != null
                ? net.authsuite.forge.ForgeServer.get().skinBroadcaster().directiveFor(canonicalUuid)
                : null;
    }

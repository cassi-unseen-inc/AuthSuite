...
public final class ForgeServer {
    ...
    private void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
        if (event.getEntity() instanceof net.minecraft.entity.player.ServerPlayerEntity) {
            net.minecraft.entity.player.ServerPlayerEntity player = (net.minecraft.entity.player.ServerPlayerEntity) event.getEntity();
    ...
    private static void setFieldForce(Object target, Field field, Object value) throws Exception {
        try {
            ...
            if ((field.getModifiers() & java.lang.reflect.Modifier.FINAL) != 0) {
                ...
                long offset = ((Number) unsafeGetMethod(objectFieldOffsetMethod, unsafe, field)).longValue();
    ...
    private static final java.lang.reflect.Method putObjectMethod;

    static {
        try {
            objectFieldOffsetMethod = findUnsafeMethod("objectFieldOffset", Field.class);
            putObjectMethod = findUnsafeMethod("putObject", Object.class, long.class, Object.class);
        } catch (Exception e) {
            throw new ExceptionInInitializerError(e);
        }
    }

    private static java.lang.reflect.Method findUnsafeMethod(String name, Class<?>... params) throws Exception {
        Class<?> unsafeClass = Class.forName("sun.misc.Unsafe");
        java.lang.reflect.Method m = unsafeClass.getMethod(name, params);
        m.setAccessible(true);
        return m;
    }

    private static Object unsafeGetMethod(java.lang.reflect.Method m, Object target, Object arg) throws Exception {

package net.authsuite.forge.skin;
...
import net.authsuite.forge.network.PlayerSkinDirectivePayload;
...
public final class SkinBroadcaster {
    ...
    public void broadcast(ServerPlayerEntity player, HybridIdentity identity) {

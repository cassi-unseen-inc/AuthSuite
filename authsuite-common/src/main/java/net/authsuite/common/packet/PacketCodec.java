...
public final class PacketCodec {
    ...
    public record PreferencePayload(String preferredProviderId, String sessionHint) {
        public boolean isEmpty() {
            return (preferredProviderId == null || preferredProviderId.isBlank())
                    && (sessionHint == null || sessionHint.isBlank());
        }
    }

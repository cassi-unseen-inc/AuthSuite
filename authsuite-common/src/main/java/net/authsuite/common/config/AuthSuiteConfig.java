...
public final class AuthSuiteConfig {
    ...
    private List<String> priority = new ArrayList<>(List.of("MA", "LS", "EB"));
    ...
    public void setClientPreferencePolicy(ClientPreferencePolicy clientPreferencePolicy) {
        this.clientPreferencePolicy = Objects.requireNonNullElse(clientPreferencePolicy, ClientPreferencePolicy.ALLOW_FALLTHROUGH);
    }
